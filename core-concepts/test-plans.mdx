...
2. Get the test plan's short ID ([6-character ID](/configuration/gitlab#finding-your-test-plan-short-id) visible in the test plan URL)
...
The `testPlanShortId` is the [6-character short ID](/configuration/gitlab#finding-your-test-plan-short-id) visible in your test plan URL (e.g., `https://app.qa.tech/.../test-plans/abc123`).

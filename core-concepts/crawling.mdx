...
Navigate to [**Settings → Crawling**](https://app.qa.tech/dashboard/current-project/settings/crawling) to access the Crawling Sessions page.
...
The URL where crawling begins (e.g., `https://app.example.com/dashboard`).

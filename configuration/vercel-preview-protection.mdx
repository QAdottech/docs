...
<Note>
This guide is for testing protected Vercel preview deployments from CI/CD pipelines. See [CI/CD Integration](/configuration/ci-cd-integration) for an overview of integrating QA.tech with CI/CD systems. For **Vercel Firewall / WAF** rules, see [Vercel Firewall](/configuration/vercel-firewall).
</Note>

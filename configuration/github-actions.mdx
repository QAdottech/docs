...
<Tabs>
    ...
    <Tab title="Direct API Integration">
        ...
        **In GitHub Actions workflow:**
        ...
        <Note>
        For complete API documentation including error responses, authentication details, and additional examples, see the [Start Run API Reference](/api-reference/start-run).
        </Note>
    </Tab>

</Tabs>

For more information about our API and other integration options, check out our [Start Run API Reference](/api-reference/start-run).
...
- **Manual testing:** Use the GitHub Action (documented above) for CI/CD workflows

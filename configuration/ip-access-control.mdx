...
1. **Get QA.tech's IP addresses** from [Settings → Network](https://app.qa.tech/current-project/settings/network) or via the [Get Outbound IPs API](/api-reference/outbound-ips)

...
<Steps>
  <Step title="Connect to Trello">
    Go to [**Settings →
    Connections**](https://app.qa.tech/current-project/settings/organization/connections),
    and add the Trello integration. Follow the OAuth flow to grant access and
    set your preferred permissions.
  </Step>
  <Step title="Configure the Project">
    Navigate to [**Settings →
    Integrations**](https://app.qa.tech/current-project/settings/integrations?focus=trello).

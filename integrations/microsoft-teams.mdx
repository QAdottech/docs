...
<Steps>
  <Step title="Create a Workflow in Microsoft Teams">
    ...
    <Frame>
      <img src="/images/workflow-teams-example.png" alt="Microsoft Teams channel menu showing the Workflows option" />
    </Frame>
    ...
    <Note>
      If the **Workflows** option is not available in your channel menu, you can also create the webhook workflow from the Microsoft 365 Workflows settings. Access Workflows through the Microsoft 365 app or at [workflows.microsoft.com](https://workflows.microsoft.com), then create a new workflow using the **"Post to a channel when a webhook request is received"** template.
    </Note>

...
| ----------- | ------ | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `testCases` | string | No       | When set, the response includes a `runTestCases` array. Use `failed` to get only failed/skipped/error test cases, or `all` to get all test cases with full details. Omit to get run metadata only (no test cases array). |

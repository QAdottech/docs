...
QA.tech uses multiple types of identifiers. Make sure you use the correct one for each API request:
...
<Steps>
  <Step title="Go to Device Presets">
    Navigate to **Settings -> Device Presets** in your project
  </Step>
  <Step title="Find Device Preset UUID">
